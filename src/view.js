...
const ICON = {
  ...
  // A send arrow, not a play triangle: this hands the prompt to a model, it does not start a process.
  send: '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M14.2 1.8 7.1 8.9"/><path d="M14.2 1.8 9.7 14.3l-2.6-5.4-5.4-2.6z"/></svg>',
